...
import {constructSignedMessageOutput} from '../../../src/fileWriter'
...
describe('Sign message output', () => {
  it('Should generate correct output for a hashed message', () => {
    const messageHex = 'fa'.repeat(349) as HexString
    ...
    const output = constructSignedMessageOutput(
      messageHex,
      hashPayload,
      signedMsgData,
    )
    const expectedOutput = {
      ...
      publicKeyHex:
        '7cc18df2fbd3ee1b16b76843b18446679ab95dbcd07b7833b66a9407c0709e37',
      COSE_Sign1_hex:
        '',
      COSE_Key_hex:
        'a40101032720062158207cc18df2fbd3ee1b16b76843b18446679ab95dbcd07b7833b66a9407c0709e37',
    }
  ...
  it('Should generate correct output for a non-hashed message', () => {
    ...
    const expectedOutput = {
      ...
      publicKeyHex:
        '650eb87ddfffe7babd505f2d66c2db28b1c05ac54f9121589107acd6eb20cc2c',
      COSE_Sign1_hex:
        '',
      COSE_Key_hex:
        'a4010103272006215820650eb87ddfffe7babd505f2d66c2db28b1c05ac54f9121589107acd6eb20cc2c',
    }
    assert.deepStrictEqual(output, expectedOutput)
  })
})
