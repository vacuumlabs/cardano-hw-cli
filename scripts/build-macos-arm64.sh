...
# Build executable
yarn pkg ./dist/index.js -o ./build/macos/archive-arm64/cardano-hw-cli/cardano-hw-cli -c package.json -t node20-macos-arm64 --options "no-warnings=ExperimentalWarning"
