...
export const enum Errors {
  ...
  Keystone3ProUnsupportedThisCommand = 'This command is currently not supported on Keystone 3 Pro. Support will be added in a future version.',
  Keystone3ProUnsupportedThisPath = 'This path is currently not supported on Keystone 3 Pro. Support will be added in a future version.',
  Keystone3ProUnsupportedMultisig = 'Multisig paths are currently not supported on Keystone 3 Pro. Support will be added in a future version.',
  ...
  TxContainsUnfixableErrors = 'Transaction CBOR contains unfixable issues',
  TxContainsFixableErrors = 'Transaction CBOR contains fixable issues, please run "transform" command first',
