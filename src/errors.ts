...
const enum Errors {
  ...
  PaymentAndColdFoundWithPoolReg = 'Only one witness can be created at time, found payment and cold/stake hwsfile at the same time with pool registration certificate',
  NoPaymentOrColdFoundWithPoolReg = 'No payment or cold/stake hwsfile found with pool registration certificate',
